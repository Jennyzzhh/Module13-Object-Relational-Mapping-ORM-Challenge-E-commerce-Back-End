...
router.put('/:id', async (req, res) => {
  ...
  try {
    ...
    // If a user does exist at the primary key, we get to use the instance method that we wrote in category.js to see if the category has id
    // const idData = categoryData.hasIds();
